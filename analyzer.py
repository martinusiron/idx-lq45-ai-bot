...
class StockAnalyzer:
    ...
    def __init__(self):
        ...
        self.min_volume_ratio = 0.3   # Volume candle harus minimal 30% dari rata-rata
                                      # (ganti threshold absolut yang tidak cocok untuk 15m)
    ...
    def analyze(self, symbol: str, threshold: int = 75) -> dict | None:
        ...
        # ── Liquidity Gate — pakai vol_ratio, bukan absolut ────────────
        ...
        logger.info(f"[{symbol}] score={score}, threshold={threshold}, market={market}, vol_ratio={vol_ratio:.2f}")
